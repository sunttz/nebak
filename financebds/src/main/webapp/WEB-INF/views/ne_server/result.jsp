...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx }/res/js/ne_server/result.js"></script>
		<script>
			var ctx='${ctx}';
			var filePath='${filePath}';//根目录
			var tmpOrgName='';
			var tmpfilePath='${filePath}';//当前目录
		</script>
	</head>	
			...
			<div id="searchPanel" class="easyui-panel" data-options="fit:true,title:'备份管理列表'" style="background:#F4F4F4;">
				<table style="height:100%;">
					...
					<tr>
						...
						<td colspan="4">默认当前只取今天的，如果需要查询其他日期，请输入条件"输入日期"，不分页</td>
					</tr>
				</table>
			</div>
	    </div>

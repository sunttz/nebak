...
<html>
	<head>
		...
		<title>我的公告</title>
		<link rel="stylesheet" type="text/css" href="${ctx }/res/theme-${uiInfo.theme }/notice/notice-published.css" >
		...
		<script type="text/javascript" src="${ctx }/res/javascript/system/notice/notice-published.js"></script>
	</head>
	<body>
		<div class="head">
			<div class="top_menu_wrap">
				...
				<!-- <div id="lookBtn" class="menu" tabindex="0">
					<span class="plaintext">查&nbsp;看</span>
					<b class="xiala"></b>
					<div class="xialapanel">
						<div id="removeBtn" class="xiaitem">直接删除</div>
						<div id="moveBtn" class="xiaitem">移动到我的草稿</div>
					</div>
				</div> -->

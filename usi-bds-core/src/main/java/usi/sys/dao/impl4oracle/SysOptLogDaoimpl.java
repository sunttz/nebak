...
@OracleDb
@Repository
public class SysOptLogDaoimpl extends JdbcDaoSupport4oracle implements SysOptLogDao {
	//保存日志的sql
	private static final String INSERT_LOG = "insert into sys_opt_log(opt_log_id,user_id, "+
											"opt_name ,opt_module ,opt_ip ,opt_content) "+
											"values(sys_opt_log_seq.nextval,?,?,?,?,?) ";
